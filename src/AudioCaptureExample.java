...
public class AudioCaptureExample extends JFrame{
  ...
  public static void main(String args[]){
    new AudioCaptureExample();
  }//end main

  public AudioCaptureExample(){//constructor
...
}//end outer class AudioCaptureExample.java
